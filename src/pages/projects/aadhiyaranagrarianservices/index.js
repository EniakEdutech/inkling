...
export const AadhiyaranAgrarianServices = props => {
    return <Fragment>
        ...
        <BIContainer className=""
            image="https://ik.imagekit.io/bizwem110d/inkling/Backgrounds_for_mobile/Aadhiyaran_mob_1_8FzNLj3qC.png" position="right" size="cover"
        ...
        <BIContainer className=""
            image="https://ik.imagekit.io/bizwem110d/inkling/Backgrounds_for_mobile/Aadhiyaran_mob_2_3X6DlB1Aj.png" size="cover"
            desImage="https://ik.imagekit.io/bizwem110d/inkling/Aadhiyaran_web_2_PisLaVXB4.png">
            <div className="d-flex column lg-row col-10 col-xlg-6 margin-center g-1 py-3 py-md-4 py-xmd-5">
        ...
        <div className="d-flex column xmd-row col-xlg-8 xlg-margin-center">
            ...
            desImage="https://ik.imagekit.io/bizwem110d/inkling/Aadhiyaran_web_3_-_wfjhJKw.png" size="cover" position="right top">
                <div className="d-flex column xmd-center col-10 col-xmd-8 h-xmd-100 margin-center py-4 px-xmd-4 r-g-1">
