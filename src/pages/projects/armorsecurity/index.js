...
export const ArmorSecurity = props => {
    return <Fragment>
        ...
        <BIContainer className=""
            image="https://ik.imagekit.io/bizwem110d/inkling/mobile_backgrounds_redone/Armor_1_x5Mr_qpHU.png" position="right top" size="cover"
        ...
        <BIContainer className=""
            ...
            <div className="d-flex center align-center col-6 col-md-8 margin-center py-3 py-md-4 py-xmd-5 py-ipp-4 py-lg-6">
