...
export const CodeForAll = props => {
    return <Fragment>
        ...
        <BIContainer className=""
            image="https://ik.imagekit.io/bizwem110d/inkling/Backgrounds_for_mobile/CFA_mob_1_MyZJsDHp3.png" position="left" size="cover"
            desImage="https://ik.imagekit.io/bizwem110d/inkling/CFA_web_1_Q1azDwNC5F.png" desPosition="right">
            <div className="d-flex column xmd-row ipp-column r-g-1 col-6 col-xmd-8 col-ipp-6 col-xlg-8 g-3 margin-center py-5 py-md-7 py-xmd-5 py-ipp-7 py-lg-5">
        ...
        <div className="d-flex column xmd-row col-12 col-xlg-8 xlg-margin-center">
            <div className="col-12 col-xmd-6">
                <BIContainer className="d-flex center align-center h-100"
                    ...
                    <div className="d-flex column col-6 col-xmd-8 col-ipp-6 py-5 r-g-1">
